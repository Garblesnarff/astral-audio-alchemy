...
const GatewayVisualizer: React.FC<GatewayVisualizerProps> = ({ 
  ...
  // Different visualizations based on focus level
  const getFocusLevelIndicator = () => {
    switch (focusLevel) {
      case 'focus10':
        return (
          <div className="absolute inset-0 flex items-center justify-center text-cyan-300/70">
            <motion.div
      ...
      case 'focus12':
        return (
          <div className="absolute inset-0 flex items-center justify-center text-blue-300/70">
            <motion.div
      ...
      case 'focus21':
        return (
          <div className="absolute inset-0 flex items-center justify-center text-purple-300/70">
            <motion.div
              animate={{ 
                scale: [1, 1.3, 1], 
                opacity: [0.7, 1, 0.7], 
  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      {/* Hemisphere synchronization visualization */}
      {isPlaying && (
